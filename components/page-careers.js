          ...
          <article className="layout">
            ...
            <div className="three-parts">
              <div className="item">
                <h4>Operations</h4>
                <p>
                  <a href="#">Bookeeper, Accounting</a>
                  <br />
                  Remote
                </p>
                <p>
                  <a href="#">Senior HR Partner</a>
                  <br />
                  Remote
                </p>
                ...
                <p>
                  <a href="#">Associate Brand Manager</a>
                  <br />
                  Remote
                </p>
                <p>
              ...
              <div className="item">
                ...
                <p>
                  <a href="#">Senior JavaScript Engineer</a>
                  <br />
                  Remote
                </p>
                <p>
                  <a href="#">Senior Software Engineer, Web</a>
                  <br />
                  Remote
                </p>
                <p>
                  <a href="#">Senior Software Engineer, CMS</a>
                  <br />
                  Remote
                </p>
              </div>
              <div className="item">
                ...
                <p>
                  <a href="#">Marketing Coordinator</a>
                  <br />
                  Remote
                </p>
              </div>
