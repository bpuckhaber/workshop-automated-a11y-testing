      ...
      <>
        ...
        <div className="wide-layout two-part-overlap">
          <div className="content-block-wrap">
            <img src={imgTents} alt="tents at sunset" />
            <div className="content-block">
              ...
              <div>
                By researching places, accomodations, and activities that match
        ...
        <div className="layout three-parts">
          <div className="item green">
            ...
            <p>
              Vel rutrum est pharetra. Suspendisse eu mattis mi. Mauris vitae
              ornare urna, et ornare felis. Lorem ipsum dolor sit amet,
