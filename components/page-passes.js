...
const PassesPage = () => {
  ...
  const Dialog = () => (
    <>
      <HeaderPortal>
        <h1 className="visually-hidden">Passes</h1>
        <Helmet>
          <title>Passes</title>
        </Helmet>
      </HeaderPortal>
      ...
      >
        <header>
          ...
          <div id="header-basic">
            <h2>
              CampSpots<span>Basic</span>
            </h2>
            <h3>$99/year</h3>
          </div>
          <div id="header-pro">
            <h2>
              CampSpots<span>Pro</span>
            </h2>
            <h3>$139/year</h3>
          </div>
        </header>
        ...
        <section className="layout-centered">
          <header className="page-header">
            <div className="page-header-content layout">
              <h2 className="primary-heading h1-style">
                ...
                <div>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <span className="text">
                        <del>Access to spa facilities &amp; restaurants</del>
                      </span>
                    </li>
                  </ul>
                  <button
                    id="btn-join-basic"
                    onClick={() => {
                      openDialog("basic", basicDialogTriggerBtnRef);
                    }}
                  ...
                  <p>
                    Vitae maximus turpis tempor <strong>nec</strong>.
                  </p>
                </div>
              </li>
              <li className="plan-pro">
                <div>
                  ...
                  <button
                    id="btn-join-pro"
                    onClick={() => {
                      openDialog("pro", proDialogTriggerBtnRef);
                    }}
                  ...
                  <p>
                    Lorem ipsum dolor <strong>sit</strong> amet, consectetur
                    adipiscing elit.
                  </p>
                </div>
              </li>
