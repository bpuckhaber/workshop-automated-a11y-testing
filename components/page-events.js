          ...
          <article className="wide-layout two-parts-70-30">
            <div>
              ...
              <ul className="event-list">
                <li>
                  <a href="https://summermeltdown.com/">
                    Summer Meltdown Festival 2022
                  </a>{" "}
                  - July 28-31, Sky Meadows Park - Darrington, WA
                </li>
                <li>YurtFest 2022 - August 5-7 - Deming, WA</li>
                <li>
                  Lopez Island Bikepacking Adventure - Ongoing - Lopez Island,
                  WA
                </li>
                <li>
                  Mountain Loop Backpacking - September, dependent on conditions
                  - Granite Falls, WA
                </li>
                <li>
                  Mountain bike skills workshops - All summer long - Bellingham,
                  WA
                </li>
              </ul>
            </div>
